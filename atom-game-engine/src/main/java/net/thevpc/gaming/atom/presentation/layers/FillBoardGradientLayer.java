...
import static net.thevpc.gaming.atom.presentation.layers.Layer.SCREEN_BACKGROUND_LAYER;
import static net.thevpc.gaming.atom.presentation.layers.Layer.UNDERGROUND_LAYER;

/**
 * @author Taha Ben Salah (taha.bensalah@gmail.com)
 */
public class FillBoardGradientLayer extends FlatBoardLayer {
    ...
    public FillBoardGradientLayer(Color color1, Color color2, Orientation direction) {
        this(UNDERGROUND_LAYER, color1, color2, direction);
    }

    public FillBoardGradientLayer(int layer, Color color1, Color color2, Orientation direction) {
    ...
    public FillBoardGradientLayer(int layer, Color color1, float x1, float y1, Color color2, float x2, float y2) {
        this.color1 = color1;
        this.color2 = color2;
        this.x1 = x1;
        this.x2 = x2;
    ...
    public FillBoardGradientLayer(Color color1, float x1, float y1, Color color2, float x2, float y2) {
