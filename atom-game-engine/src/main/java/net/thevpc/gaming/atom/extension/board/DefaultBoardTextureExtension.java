...
*/
package net.thevpc.gaming.atom.extension.board;
import net.thevpc.gaming.atom.debug.AtomDebug;
import net.thevpc.gaming.atom.engine.SceneEngineChangeAdapter;
import net.thevpc.gaming.atom.engine.SceneEngineChangeListener;
import net.thevpc.gaming.atom.extension.DefaultSceneExtension;
...
import net.thevpc.gaming.atom.presentation.layers.BoardLayer;
import net.thevpc.gaming.atom.presentation.layers.BoardLayerDrawingContext;
...
import net.thevpc.gaming.atom.presentation.layers.InteractiveLayer;
...
//    }
    ...
    public void install(Scene scene) {
        ...
        scene.addChangeListener(sceneChangeListener);
    ...
    public void uninstall(Scene scene) {
        ...
        scene.removeChangeListener(sceneChangeListener);
        if (scene.getSceneEngine() != null) {
