...
import net.vpc.gaming.atom.engine.pathfinder.AStarTilePathFinder;
import net.vpc.gaming.atom.engine.pathfinder.TilePathFinder;
import net.vpc.gaming.atom.engine.pathfinder.TransitionStrategy;
import net.vpc.gaming.atom.engine.pathfinder.TransitionStrategy8;
 ...
 */
public class FindPathToPointSpriteTask implements MotionSpriteTask {
    ...
    public FindPathToPointSpriteTask(ModelPoint point) {
        this(point, 0, true);
    }

    public FindPathToPointSpriteTask(ModelPoint point, double minDistance, boolean center) {
