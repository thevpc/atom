...
public class DefaultSprite implements Sprite {
    ...
    private transient SpriteTask task;
    private transient SpriteCollisionManager collisionManager;
    ...
    @Override
    public SpriteTask getTask() {
        if (sceneEngine == null) {
            return task;
        } else {
            return getSceneEngine().getSpriteTask(this);
        }
    }
    ...
    public Sprite setTask(SpriteTask task) {
        if (sceneEngine == null) {
            this.task = task;
        } else {
            getSceneEngine().setSpriteTask(this, task);
        }
        return this;
    }

    @Override
    public SpriteCollisionManager getCollisionManager() {
        if (sceneEngine == null) {
            return collisionManager;
        } else {
            return getSceneEngine().getSpriteCollisionManager(this);
        }
    }

    public Sprite setCollisionManager(SpriteCollisionManager collisionManager) {
        if (sceneEngine == null) {
            this.collisionManager = collisionManager;
        } else {
            getSceneEngine().setSpriteCollisionManager(this, collisionManager);
        }
        return this;
    }
