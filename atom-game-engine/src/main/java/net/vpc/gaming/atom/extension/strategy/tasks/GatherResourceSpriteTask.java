 ...
 */
package net.vpc.gaming.atom.extension.strategy.tasks;
import net.vpc.gaming.atom.engine.SceneEngine;
import net.vpc.gaming.atom.engine.tasks.FindPathToSpriteSpriteTask;
import net.vpc.gaming.atom.engine.tasks.MotionSpriteTask;
import net.vpc.gaming.atom.extension.strategy.resources.RepositoryEmptyException;
import net.vpc.gaming.atom.extension.strategy.resources.RepositoryFullException;
 ...
 */
public class GatherResourceSpriteTask implements MotionSpriteTask {
    ...
    private FindPathToSpriteSpriteTask moveToTask = null;
//    private int gatherPeriod = 10;

    public GatherResourceSpriteTask(int commandCenterId, int resourceId) {
...
//                    sprite.setTask(new HoldPositionSpriteTask());
                    state = State.GOTO_STOCK;
                } catch (RepositoryEmptyException e) {
//                    sprite.setTask(new HoldPositionSpriteTask());
