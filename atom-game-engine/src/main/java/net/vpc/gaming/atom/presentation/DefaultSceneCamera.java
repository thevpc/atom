...
//        });
    ...
    public ViewBox getViewBounds() {
        RatioViewBox camera = scene.getModel().getCamera();
    ...
    public void setBounds(RatioViewBox rect) {
    ...
    @Override
    public RatioViewBox getRatioViewBounds() {
    ...
    public void setDimension(RatioDimension ratioDimension) {
        ...
        RatioViewBox c = getRatioViewBounds();
        if (c == null) {
            setBounds(
                    new RatioViewBox(
                            0, 0, 0,
            ...
            setBounds(
                    scene.validateRatioViewBox(new RatioViewBox(
