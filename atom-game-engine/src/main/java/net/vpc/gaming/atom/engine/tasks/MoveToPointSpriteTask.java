 ...
 */
public class MoveToPointSpriteTask implements MotionSpriteTask {
    ...
    public MoveToPointSpriteTask(ModelPoint point) {
        this(point, Double.NaN, false);
    }

    public MoveToPointSpriteTask(ModelPoint point, double speed) {
        this(point, speed, false);
    }

    public MoveToPointSpriteTask(ModelPoint point, double speed, boolean center) {
