 ...
 */
public class SimpleSpriteCollisionManager extends DefaultSpriteCollisionManager {
     ...
     */
    public SimpleSpriteCollisionManager() {
        this(true, true, true);
    }
     ...
     */
    public SimpleSpriteCollisionManager(boolean stopOnBorder, boolean stopOnWall, boolean stopOnSprite) {
    ...
    /**
     * {@inheritDoc}
     * this implementation handles nested collision detected
     */
