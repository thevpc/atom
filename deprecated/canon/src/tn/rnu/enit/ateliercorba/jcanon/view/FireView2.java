 ...
 */
public class FireView2 extends ImageSpriteView
{

    public FireView2() {
        super(
           new Image[]{
                    new ImageIcon(PlayerView.class.getResource("fire1_0.png")).getImage()
                   ,new ImageIcon(PlayerView.class.getResource("fire1_1.png")).getImage()
                   ,new ImageIcon(PlayerView.class.getResource("fire1_2.png")).getImage()
