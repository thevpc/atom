 ...
 */
package net.vpc.gaming.atomgames.pong.hello.presentation.view;
...
public class WelcomeLayer extends DefaultLayer {
    ...
    public void draw(LayerDrawingContext context) {
        ...
        int screenWidth = context.getScene().getCameraScreen().getWidth();
...
//        drawLabel(graphics, "So Pong..."        , 5, 15, 70, 100, 400, 20, verdana50B, new Color(0,0,100+(int)(model.getFrame()%155)), null);
        ...
        drawLabel(graphics, "Serveur", 40, 20, 200, 220, 200, 30, verdana20B, Color.WHITE, Color.RED, r == AppRole.SERVER, SwingConstants.CENTER);
